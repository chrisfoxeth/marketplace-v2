    ...
    return (
      <div className="flex w-screen items-center justify-center gap-2 bg-[#FFA500] p-4 text-black">
        ...
        <button
          ...
          className="btn-primary-outline gap-1 text-white rounded-full border-transparent bg-gray-100 normal-case focus:ring-0 dark:border-neutral-600 dark:bg-neutral-900 dark:ring-primary-900 dark:focus:ring-4"
        >
          <span>Switch to</span>
