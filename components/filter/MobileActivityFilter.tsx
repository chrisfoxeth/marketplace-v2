  ...
  return (
    <Dialog.Root onOpenChange={setOpen} open={open} modal={true}>
      <div className="fixed left-0 bottom-6 z-10 flex w-screen flex-col items-center md:hidden">
        {data && (
          <Dialog.Trigger className="btn-primary-outline min-w-[200px] text-white luckiestguy text-2xl rounded-full bg-white py-3 px-12 text-center shadow-[0px_10px_8px_rgba(0,0,0,0.04)] shadow-[_0px_4px_3px_rgba(0,0,0,0.1)] dark:bg-black">
            <span>Filter</span>
            {hasEnabledFilters && (
